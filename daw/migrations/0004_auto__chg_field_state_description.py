...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('daw_state', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'State.description'
        db.alter_column('daw_state', 'description', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
    ...
    models = {
        ...
        'daw.state': {
            'Meta': {'ordering': "('created_at',)", 'object_name': 'State'},
